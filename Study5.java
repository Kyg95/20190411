...
//////////////////////////////////////
	...
	MenuWindow(String str) {
		...
		btns = new Button[5];
		btns[0] = new Button("첫번째 버튼");
		btns[0].setFont(font);
		btns[1] = new Button("두번째 버튼");
		btns[1].setFont(font);
		btns[2] = new Button("세번째 버튼");
		btns[2].setFont(font);
		btns[3] = new Button("네번째 버튼");
		btns[3].setFont(font);
		btns[4] = new Button("다섯번째 버튼");
		btns[4].setFont(font);
